...
class MiniHeadingLinedWidget extends StatelessWidget {
  final String title;
  const MiniHeadingLinedWidget({Key? key, required this.title})
      : super(key: key);
      ...
      child: Row(
        ...
        children: [
          ...
          Padding(
            ...
            child:
                Text(title.toUpperCase(), style: ThemeHeadings.themeHeading5),
          ),
          const _Line(),
        ],
      ),
