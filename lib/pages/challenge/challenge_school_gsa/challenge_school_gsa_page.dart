...
class ChallengeSchoolGsaPage extends StatelessWidget {
  ChallengeSchoolGsaPage({Key? key, required this.uuid}) : super(key: key);
  final String uuid;

  @override
  Widget build(BuildContext context) {
    BlocProvider.of<ChallengeSchoolGsaCubit>(context)
