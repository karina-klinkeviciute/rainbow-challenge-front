...
class ChallengeQuizPage extends StatefulWidget {
  ...
  @override
  State<ChallengeQuizPage> createState() => _ChallengeQuizPageState(type_uuid: type_uuid, uuid: uuid);
...
class _ChallengeQuizPageState extends State<ChallengeQuizPage> {
  ...
  Widget _challengeForm = ElevatedButton(
    ...
    var quizChallenge = await BlocProvider.of<ChallengeQuizCubit>(context)
